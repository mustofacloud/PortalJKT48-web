...
const About = () => {
  ...
  return (
    ...
    <div className="flex justify-center gap-6 mb-8">
      <a
        href="https://github.com/mustofacloud"
        target="_blank"
      ...
      <a
        href="https://saweria.co/MasThopa"
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 bg-gray-800 hover:bg-red-700 text-white px-6 py-3 rounded-lg transition-colors"
      >
        <img src={saweriaIcon} alt="Saweria" className="w-5 h-5 rounded-full" />
        Saweria
      </a>
    </div>
